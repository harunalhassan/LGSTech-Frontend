  ...
  return (
    <div className="project-container"data-aos="fade-up"data-aos-duration="1000">
      ...
      <h2 className="project-subtitle">
        A Milestone for LGS, DDPTech and XAPT Partnership
      </h2>

      <p className="project-text">
        We at LGS are excited to announce the successful completion and
        ...
        collaboration between the LGS, DDPTech, Foley teams, and our partners at
      ...
      <p className="project-text">
        ...
        accomplishment marks several firsts for LGS and further solidifies
      ...
      <p className="project-text">
        Numerous team members from LGS, DDPTech, Foley, and XAPT contributed to
        this outstanding outcome, showcasing the power of collaboration and
        dedication among the partners.
      </p>

      <p className="project-text">
        At LGS, our mission is to help you reach your goals – Smarter,
        Faster, Safer and Better. This successful project completion showcases our
